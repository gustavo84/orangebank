...
public class OrangebankTests {
    ...
    public void createTransactionTest() throws Exception {
        try {
            business.createTransaction(new Transaction("a", "a", new Date(), 31324.2, 22.3, ""));;
            fail("expected exception was not occured.");
        }catch(Exception e) {
            
        }
        business.createTransaction(new Transaction("aa01", "ES9820385778983000760236", new Date(), 31324.2, 22.3, ""));
